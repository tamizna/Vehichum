...
public class BensinMobil extends AppCompatActivity implements View.OnClickListener {

    SearchView cariBensinMobil;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_bensin_mobil);

        cariBensinMobil = findViewById(R.id.searchView);
