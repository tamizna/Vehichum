...
public class BengkelMotor extends AppCompatActivity implements View.OnClickListener {

    SearchView cariBengkelMotor;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_bengkel_motor);

        cariBengkelMotor = findViewById(R.id.searchView);
